...
class EmbedScTrainingBlock extends BlockBase {
  ...
  public function build(): array {
    return [
      '#markup' => '<div class="hudx-smart-embed"><iframe class="hudx-smart-embed__iframe" src="' . self::EMBED_URL . '" frameborder="0" scrolling="no" title="' . self::EMBED_TITLE . '" allowfullscreen></iframe></div>',
      '#attached' => [
