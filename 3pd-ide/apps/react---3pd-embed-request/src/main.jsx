...
function mountHudxReactApp(context = document) {
  const el = context.getElementById
    ? context.getElementById("hudx-react---3pd-embed-request-root")
    : document.getElementById("hudx-react---3pd-embed-request-root");
...
if (typeof window !== "undefined" && window.Drupal && window.Drupal.behaviors) {
  (function (Drupal) {
    Drupal.behaviors.HudxReact3pdEmbedRequestBehavior = {
      attach(context) {
